...
namespace LiteInvoice.Data.Migrations
{
    ...
    [Migration("20240204154256_InvoiceProjectId")]
    partial class InvoiceProjectId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiteInvoice.Data.Entities.Customer", b =>
                {
                    b.HasOne("LiteInvoice.Data.Entities.Business", "Business")
                        .WithMany()
            ...
            modelBuilder.Entity("LiteInvoice.Data.Entities.Project", b =>
                {
                    b.HasOne("LiteInvoice.Data.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("LiteInvoice.Data.Entities.WorkEntry", b =>
                {
                    b.HasOne("LiteInvoice.Data.Entities.Project", "Project")
                        .WithMany()
